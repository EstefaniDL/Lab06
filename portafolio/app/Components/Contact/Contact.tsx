        ...
        <div className={styles.contact__content}>
            ...
            <div className={styles.contact__data}>
              ...
              <div className={styles.contact__item}>
                ...
                <div className={styles.contact__text}>
                  ...
                  <a 
                    href="mailto:estefaniemdl@gmail.com" 
                    className={styles.contact__value}
                  >
                    estefaniemdl@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className={styles.contact__item}>
                ...
                <div className={styles.contact__text}>
                  <span className={styles.contact__label}>Accesibilidad</span>
                  <span className={`${styles.contact__value} ${styles["contact__value--available"]}`}>
                    Disponible para prácticas profesionales y proyectos de desarrollo
                  </span>
                </div>
              </div>
          ...
          <div className={styles.contact__cta}>
            <div className={styles.contact__card}>
              ...
              <a
                href="mailto:estefaniemdl@gmail.com"
                className={`${styles.btn} ${styles["btn--primary"]} ${styles["btn--large"]} ${styles["btn--full"]}`}
              >
